...
export const translations: Record<Language, Translation> = {
  en: {
    ...
    copyright: '© 2024 Memorpho. All rights reserved.',
    legal: 'Legal',
    privacy: 'Privacy',
    terms: 'Terms',
  ...
  az: {
    ...
    newToMemorpho: 'Memorpho-da yenisiniz?',
    ...
    downloadQRDesc: 'Bunları masa kartlarına çap edin və ya tədbir məkanınızda nümayiş etdirin.',
    ...
    uploadFaceDesc: 'Selfi yükləyin ve biz sizin tədbirdəki bütün fotolarınızı tapacağıq.',
    ...
    getStarted: 'Başlayın',
    aiFaceSearchWhyDesc: 'Qonaqlar süni intellektlə üz axtarışı vasitəsilə öz fotolarını anında tapırlar.',
    qrSharingTitle: 'QR əsaslı paylaşım',
    qrSharingDesc: 'Tək bir link və ya QR kod paylaşın. Hər kəs anında giriş əldə etsin.',
    autoExpiringTitle: 'Avtomatik vaxtı bitən tədbirlər',
    autoExpiringDesc: 'Hər şeyi sadə və təhlükəsiz saxlamaq üçün tədbirlər müəyyən müddətdən sonra avtomatik bağlanır.',
    smartBrowsingTitle: 'Ağıllı baxış və filtrlər',
    smartBrowsingDesc: 'Qonaqlar bütün fotolara baxa və ya cinsiyyət, qrup ölçüsü və s. görə filtrləyə bilər.',
    collaborativeEventsTitle: 'Birgə tədbirlər',
    collaborativeEventsDesc: 'Bir tədbirə çoxlu fotoqraf dəvət edin və fotoları birlikdə rahatca yükləyin.',
    ...
    poweredBy: 'Memorpho tərəfindən dəstəklənir',
    ...
    copyright: '© 2024 Memorpho. Bütün hüquqlar qorunur.',
    legal: 'Hüquqi',
    privacy: 'Məxfilik',
    terms: 'Şərtlər',
    supportTitle: 'Dəstək',
  ...
  tr: {
    ...
    newToMemorpho: 'Memorpho\'da yeni misiniz?',
    ...
    poweredBy: 'Memorpho tarafından desteklenmektedir',
    ...
    copyright: '© 2024 Memorpho. Tüm hakları saklıdır.',
    legal: 'Yasal',
    privacy: 'Gizlilik',
    terms: 'Şartlar',
    supportTitle: 'Destek',
  ...
  ru: {
    ...
    newToMemorpho: 'Впервые в Memorpho?',
    ...
    copyright: '© 2024 Memorpho. Все права защищены.',
